...
- Browser API occurrences reviewed: 321.

| API                  | Static occurrences | Guard/cleanup policy                                              |
| -------------------- | -----------------: | ----------------------------------------------------------------- |
| window               |                 14 | Platform guard, feature detection, and lifecycle cleanup required |
| document             |                216 | Platform guard, feature detection, and lifecycle cleanup required |
| navigator            |                  4 | Platform guard, feature detection, and lifecycle cleanup required |
| localStorage         |                 12 | Platform guard, feature detection, and lifecycle cleanup required |
