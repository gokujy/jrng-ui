...
Strict consumer compilation covers 127 final entrypoints. Removed selectors, entrypoints, class aliases, input aliases, output aliases, and old type values are not part of the v0.1.0 surface.
