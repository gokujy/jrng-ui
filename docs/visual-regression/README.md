...
The deterministic manifest covers 34 critical components. Captures must block network access, disable animation, use fixed data/timestamps and run every declared viewport/theme/state.
