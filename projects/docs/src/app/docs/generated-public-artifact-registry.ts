...
export const generatedPublicArtifactRegistry = [
  ...
  {
    name: 'Grid Layout Drag Handle',
    identifier: 'JGridLayoutDragHandleDirective',
    selector: '[jGridLayoutDragHandle]',
    importPath: 'jrng-ui/grid-layout',
    kind: 'Directive',
    stability: 'Stable',
    description:
      'Grid Layout Drag Handle adds typed host behavior through [jGridLayoutDragHandle].',
    signatures: [],
    ssr: 'Feature-detected browser integration.',
    cleanup: 'Lifecycle cleanup is required and covered by canonical tests.',
  },
  {
    name: 'Grid Layout Item Template',
    identifier: 'JGridLayoutItemTemplateDirective',
  ...
  {
    name: 'Grid Layout Resize Handle',
    identifier: 'JGridLayoutResizeHandleDirective',
    selector: '[jGridLayoutResizeHandle]',
    importPath: 'jrng-ui/grid-layout',
    kind: 'Directive',
    stability: 'Stable',
    description:
      'Grid Layout Resize Handle adds typed host behavior through [jGridLayoutResizeHandle].',
    signatures: [],
    ssr: 'Feature-detected browser integration.',
    cleanup: 'Lifecycle cleanup is required and covered by canonical tests.',
  },
  ...
  {
    name: 'POPOUT REF',
    identifier: 'J_POPOUT_REF',
    selector: null,
    importPath: 'jrng-ui/popout',
    kind: 'Token',
    stability: 'Stable',
    description: 'POPOUT REF configures a public JRNG provider contract.',
    signatures: [],
    ssr: 'Feature-detected browser integration.',
    cleanup: 'Lifecycle cleanup is required and covered by canonical tests.',
  },
  {
    name: 'POPOUT WINDOW ADAPTER',
    identifier: 'J_POPOUT_WINDOW_ADAPTER',
    selector: null,
    importPath: 'jrng-ui/popout',
    kind: 'Token',
    stability: 'Stable',
  ...
  },
  {
    ...
    identifier: 'JSpeechRecognitionService',
    selector: null,
    ...
    signatures: [
      ...
      'readonly finalTranscript: _angular_core.WritableSignal<string>;',
      'readonly error: _angular_core.WritableSignal<JSpeechRecognitionError | null>;',
      'readonly supported: _angular_core.WritableSignal<boolean>;',
      'constructor();',
  ...
  {
    name: 'SPEECH RECOGNITION FACTORY',
    identifier: 'J_SPEECH_RECOGNITION_FACTORY',
    selector: null,
    importPath: 'jrng-ui/speech-to-text',
    kind: 'Token',
    stability: 'Stable',
  ...
  {
    name: 'Speech To Text',
    identifier: 'JSpeechToTextDirective',
    selector:
    ...
    stability: 'Stable',
    description:
      'Speech To Text adds typed host behavior through input[jSpeechToText], textarea[jSpeechToText], j-input[jSpeechToText], j-textarea[jSpeechToText], j-editor[jSpeechToText].',
    signatures: [
      'readonly service: JSpeechRecognitionService;',
      'readonly language: _angular_core.InputSignal<string>;',
      'readonly continuous: _angular_core.InputSignalWithTransform<boolean, unknown>;',
      'readonly singleResult: _angular_core.InputSignalWithTransform<boolean, unknown>;',
      'readonly interim: _angular_core.InputSignalWithTransform<boolean, unknown>;',
      'readonly mode: _angular_core.InputSignal<JSpeechInsertionMode>;',
      'readonly separator: _angular_core.InputSignal<string>;',
      'readonly disabled: _angular_core.InputSignalWithTransform<boolean, unknown>;',
      'readonly listeningChange: _angular_core.OutputEmitterRef<boolean>;',
      'readonly interimTranscript: _angular_core.OutputEmitterRef<string>;',
      'readonly finalTranscript: _angular_core.OutputEmitterRef<string>;',
      'readonly stateChange: _angular_core.OutputEmitterRef<JSpeechRecognitionState>;',
      'readonly speechError: _angular_core.OutputEmitterRef<JSpeechRecognitionError>;',
      'constructor();',
      'start(): boolean;',
      'stop(): void;',
      'cancel(): void;',
  ...
  },
  {
    ...
    identifier: 'JSpeedDialTriggerDirective',
