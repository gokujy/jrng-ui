...
export const demoSources = {
  'avatar-zoom-demo': {
    html: '<div class="profile">\n  <j-avatar image="/assets/images/avatar-user-01.webp" label="Avery Reed" size="lg" previewable />\n  <div><strong>Avery Reed</strong><span>Product designer</span></div>\n</div>\n',
