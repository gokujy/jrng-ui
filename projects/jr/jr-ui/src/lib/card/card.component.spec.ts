...
@Component({
  ...
  template: `
    <jr-card [title]="title" [subtitle]="subtitle" [variant]="variant" [clickable]="clickable">
      <div jrCardHeader>Custom header</div>
      <p>Main body</p>
      <div jrCardBody>Extra body</div>
      <button jrCardFooter>Action</button>
    </jr-card>
  `,
})
...
describe('JrCardComponent', () => {
  ...
  it('applies variant class', () => {
    ...
    expect(card().classList).toContain('jr-card--soft');
  });
