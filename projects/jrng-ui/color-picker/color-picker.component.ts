...
@Component({
  ...
  styles: [
    `
      ...
      .j-color-picker__trigger:focus-visible {
      ...
      .j-color-picker.is-invalid .j-color-picker__trigger {
        border-color: var(--j-color-danger);
      }
      .j-color-picker__message {
        color: var(--j-color-muted-foreground);
        font-size: var(--j-font-size-xs);
        margin: 0;
      }
      .j-color-picker__message--error {
