import { JTreeTableCellTemplateDirective } from './tree-table-template.directive';

describe('JTreeTableCellTemplateDirective public contract', () => {
  const metadata = (
    JTreeTableCellTemplateDirective as unknown as {
      ɵdir: {
        selectors: unknown[];
