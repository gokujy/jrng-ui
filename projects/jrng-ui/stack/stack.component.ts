...
@Component({
  selector: 'j-stack',
  imports: [],
  template: `<div [class]="classes()" data-jc-name="stack" data-jc-section="root">
    <ng-content />
  </div>`,
  styles: [
    `
      ...
      .j-stack--vertical {
        --j-stack-direction: column;
      }
      .j-stack--horizontal {
        --j-stack-direction: row;
      }
      .j-stack--align-start {
        --j-stack-align: flex-start;
      }
      .j-stack--align-center {
        --j-stack-align: center;
      }
      .j-stack--align-end {
        --j-stack-align: flex-end;
      }
      .j-stack--align-stretch {
        --j-stack-align: stretch;
      }
      .j-stack--justify-start {
        --j-stack-justify: flex-start;
      }
      .j-stack--justify-center {
        --j-stack-justify: center;
      }
      .j-stack--justify-end {
        --j-stack-justify: flex-end;
      }
      .j-stack--justify-between {
        --j-stack-justify: space-between;
      }
    `,
  ],
