...
import { JrToastService } from '../toast/toast.service';
...
@Component({
  ...
  template: `
    ...
    >
      <section class="j-notification-center__panel" data-jc-name="notification-center" data-jc-section="root">
        <header class="j-notification-center__header">
          <strong>{{ heading }}</strong>
          <button type="button" class="j-notification-center__clear" (click)="toastService.clear()">{{ clearLabel }}</button>
        </header>
