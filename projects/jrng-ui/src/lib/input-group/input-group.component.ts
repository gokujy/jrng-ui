...
@Component({
  ...
  template: `
    ...
    >
      ...
      @if (prefixIcon()) {
        <span class="j-input-group__icon" data-jc-section="prefix-icon" aria-hidden="true">{{ prefixIcon() }}</span>
      }
      ...
      @if (suffixIcon()) {
        <span class="j-input-group__icon" data-jc-section="suffix-icon" aria-hidden="true">{{ suffixIcon() }}</span>
      }
      @if (suffixAddon()) {
