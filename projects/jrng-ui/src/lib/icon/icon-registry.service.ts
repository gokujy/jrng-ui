...
export const JRNG_DEFAULT_ICONS: JIconMap = {
  ...
  boxes: 'M2.97 12.92 7 15.1l4.03-2.18M2.97 12.92V8.54L7 6.36l4.03 2.18v4.38M7 15.1v4.36l4.03 2.18 4.03-2.18V15.1M11.03 12.92l4.03 2.18 4.03-2.18M15.06 15.1v4.36M11.03 8.54 15.06 6.36l4.03 2.18v4.38M15.06 6.36V2l-4.03 2.18L7 2v4.36',
  'folder-code': 'M10 10.5 8 13l2 2.5M14 10.5l2 2.5-2 2.5M3 7V5a2 2 0 0 1 2-2h4l2 2h8a2 2 0 0 1 2 2v12a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2V7Z',
  ...
  'book-open': 'M12 7v14M3 5a2 2 0 0 1 2-2h4a3 3 0 0 1 3 3v15a3 3 0 0 0-3-3H5a2 2 0 0 0-2 2V5ZM21 5a2 2 0 0 0-2-2h-4a3 3 0 0 0-3 3v15a3 3 0 0 1 3-3h4a2 2 0 0 1 2 2V5Z',
  'panel-left': 'M3 3h18v18H3V3ZM9 3v18',
  palette: 'M12 22a10 10 0 1 1 10-10c0 1.66-1.34 3-3 3h-1.77c-.86 0-1.23 1.1-.55 1.62.41.31.65.8.65 1.31A4.07 4.07 0 0 1 13.26 22H12ZM7.5 10.5h.01M10.5 7.5h.01M14.5 7.5h.01M16.5 10.5h.01',
  component: 'M5.5 8.5 9 5l3.5 3.5L9 12 5.5 8.5ZM12 15.5 15.5 12l3.5 3.5-3.5 3.5-3.5-3.5ZM5 16h4v4H5v-4ZM15 4h4v4h-4V4Z',
  ...
  badge: 'M7.5 7.5h9v9h-9zM12 2l2.2 3.8L18.5 5l-.8 4.3L21 12l-3.3 2.7.8 4.3-4.3-.8L12 22l-2.2-3.8-4.3.8.8-4.3L3 12l3.3-2.7L5.5 5l4.3.8L12 2Z',
  ...
  route: 'M6 19a3 3 0 1 0 0-6 3 3 0 0 0 0 6ZM18 11a3 3 0 1 0 0-6 3 3 0 0 0 0 6ZM6 16h8a4 4 0 0 0 4-4v-1',
  'panel-left-open': 'M3 3h18v18H3V3ZM9 3v18M14 9l3 3-3 3',
  'message-square-more': 'M21 15a2 2 0 0 1-2 2H8l-5 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2v10ZM8 10h.01M12 10h.01M16 10h.01',
  ...
  lightbulb: 'M9 18h6M10 22h4M15.09 14c.18-.98.74-1.86 1.48-2.57A6 6 0 1 0 7.43 11.43c.74.71 1.3 1.59 1.48 2.57h6.18Z',
  'triangle-alert': 'M12 9v4M12 17h.01M10.29 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.71 3.86a2 2 0 0 0-3.42 0Z',
};
