...
describe('JAvatarGroupComponent', () => {
  ...
  it('renders the configured number of members and an accessible overflow count', () => {
    ...
    expect(items[2].nativeElement.textContent.trim()).toBe('+2');
    expect(items[2].attributes['aria-label']).toBe('2 more');
  ...
  it('handles a zero or negative maximum without throwing', () => {
    ...
    fixture.detectChanges();
    const overflow = fixture.debugElement.query(By.css('.j-avatar-group__item'));
